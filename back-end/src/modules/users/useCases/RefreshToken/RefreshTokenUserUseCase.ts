...
export class RefreshTokenUserUseCase implements IUseCase<number, { token: string; refreshToken?: IRefreshToken }> {
    constructor(private readonly refreshTokenService: RefreshTokenService) { }

    async execute(id: number): Promise<{ token: string; refreshToken?: IRefreshToken }> {

...
const productPrismaRepository = new ProductPrismaRepository(productPrismaFactory)
...
const createOrderItemUseCase = new CreateOrderItemUseCase(createOrderItemService)
